...
const contents = [
    { title: 'Início 2017', subtitle: 'Tudo começou em 2017 quando, ao enfrentar dificuldades em cuidar de um peixe betta e em encontrar informações, decidi criar um canal para ajudar pessoas com dificuldades no Aquarismo.' },
    ...
    { title: 'Nosso Primeiro Evento', subtitle: 'Com o apoio de algumas empresas, decidimos realizar nosso primeiro evento com o objetivo de divulgar o hobby e apoiar nossos colegas aquaristas, foi uma oportunidade maravilhoda de divulgar o hobbie e conhecer melhor nossos inscritos.' },
    { title: 'Ganhamos nossa Marca', subtitle: 'Com o apoio do nosso amigo Diego, recebemos uma arte que se tornou nossa marca registrada desde então, feita com muito carinho por quem acompanhou nossa trajetória também foi recebida com muito carinho e é usada desde então.' },
...
function carossel() {
    ...
    imgs.style.transform = `translateX(${-idx *232}px)`;
